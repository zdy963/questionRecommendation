...
CREATE TABLE `SJD_QUESTION_BANK` (
  ...
  */
  ...
  `FIRST_ACCURACY`    FLOAT(4,2)    DEFAULT'0'             COMMENT '首次正确率', -- 记录用户首次答题的正确率
  `AVERAGE_ACCURACY`  FLOAT(4,2)    DEFAULT'0'             COMMENT '平均正确率',
...
CREATE TABLE SJD_MULTI_CHOICE(
  ...
  `SELECTION_E` VARCHAR(140)           COMMENT 'D选项信息',
  `SELECTION_F` VARCHAR(140)           COMMENT 'E选项信息',
  `SELECTION_G` VARCHAR(140)           COMMENT 'F选项信息',
